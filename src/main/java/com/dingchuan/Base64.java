...
//    byte[] decode = java.util.Base64.getDecoder().decode(context);
//    List<Byte> list = Bytes.asList(decode);
//    EasyExcelUtil.exportExcel();
//
//  }

//  @Test
//  void exportToCsvTest(@TempDir File tempDir) throws IOException {
//    // Arrange
//    HttpServletResponse mockResponse = Mockito.mock(HttpServletResponse.class);
//    List<String> testData = Arrays.asList("Row1", "Row2", "Row3");
//    String fileName = new File(tempDir, "test.csv").getAbsolutePath();
//    Class<?> clazz = String.class;
//
//    // Act & Assert
//    assertDoesNotThrow(() -> EasyExcelUtil.exportToCsv(mockResponse, testData, fileName, clazz));
//
//    // Verify file creation and content
//    File createdFile = new File(fileName);
//    assert createdFile.exists();
//    assert createdFile.length() > 0;
//
//    // Verify file content (manually as it's a CSV file)
//    try (BufferedReader reader = new BufferedReader(new FileReader(createdFile))) {
//      String line;
//      int row = 1;
//      while ((line = reader.readLine()) != null) {
//        assertEquals(testData.get(row - 1), line);
//        row++;
//      }
//      assertEquals(testData.size(), row - 1); // Check the number of rows
//    }
//  }
