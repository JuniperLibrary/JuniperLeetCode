package main.java.com.uin.leetcode_100.dp.leetcode_1774;
...
public class Main {
    ...
    public int closestCost(int[] baseCosts, int[] toppingCosts, int target) {
        // baseCosts 冰淇淋基料，其中每个item表示冰淇淋基料的价格。必须选择一种冰淇凌基料。
        // toppingCosts 配料，其中每个item冰淇淋配料的价格。可以添加一种或多种配料，也可以不添加任何配料。每种类型的配料 最多两份。
        // target 甜点的目标价格
//        int sum = 0;
//        for (int baseCost : baseCosts) {
//            for (int toppingCost : toppingCosts) {
//                sum = baseCost + toppingCost;
//                if (target < sum && baseCost <= target) {
//                    return baseCost;
//                }
//            }
//        }
